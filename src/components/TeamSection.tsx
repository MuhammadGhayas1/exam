  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      social: {
        ...
        linkedin: "https://www.linkedin.com/in/javeria-arshad-877a08349?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16 team-animate opacity-0 transition-all duration-1000">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto text-lg">
            Meet the talented individuals behind the Examination System project, combining expertise in Java development, 
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 mx-auto max-w-7xl">
          {teamMembers.map((member, index) => (
            <div 
              key={index} 
              className={`team-animate opacity-0 transition-all duration-1000 delay-${index * 100}`}
            >
